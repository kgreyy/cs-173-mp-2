...
sp.add_compilation_target("escrow", Escrow(sp.address("tz1SHC1xaNZsZ19K4nJYoLutQYt5J3qJhUBc"), sp.tez(50), sp.address("tz1UyzaiJhQyNNTDfBBz8mUXkBMvatBqmKgn"), sp.tez(4), sp.timestamp(123), sp.bytes("0xc2e588e23a6c8b8192da64af45b7b603ac420aefd57cc1570682350154e9c04e")))
